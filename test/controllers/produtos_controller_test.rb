...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { codigo: @produto.codigo, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, quantidade_estoque: @produto.quantidade_estoque } }
    end
