Feature: Efetuar pedido
  ...
  Scenario: Vizualizar um produto
    ...
    Then Eu vejo o produto com o codigo 11
  ...
  Scenario: Adicionar um produto ao carrinho
    ...
    Then Eu vejo que o produto de codigo 11 foi adicionado ao meu carrinho
  ...
  Scenario: Retirar produto do carrinho
    Given Existe um produto com o codigo 1 e preco 9.99
    And Eu estou logado como cliente
    And O produto com codigo 11 e preco 9.99 foi adicionado ao carrinho
    When Eu seleciono a opcao de remover o produto de codigo 11 do carrinho
    Then Eu vejo que o produto de codigo 11 foi removido corretamente do carrinho
